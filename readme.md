...
Simple implementation of a DNS nameserver in C#. Currently it is only a Stub Resolver, but it is extensible to support other resolution strategies such as recursive queries or responding authoritatively.
